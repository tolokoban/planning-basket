 ...
 */
function findBestTeam( config, day, type ) {
  var obligation = config.obligations[ day ];
  if ( obligation ) {
  ...
  var teams = config[ type == 'G' ? 'go' : 'back' ];
  var bestTeam = null;
